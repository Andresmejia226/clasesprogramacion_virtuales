...
namespace clasesvirtualesprogramacion
{
    class admConexion
    {
        ...
        /*Funcion para abrir una conexion, si el estado de misma es abierto, entonces que esta sea cerrado
         para abrir  nueva conexion*/
        ...
        /*Funcion para ejecutar instruciones SQL de accion insert, update, delete*/
